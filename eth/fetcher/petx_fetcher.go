...
// pendingEtxsRetrievalFn is a callback type for retrieving a header from the local chain.
type pendingEtxsRetrievalFn func(common.Hash) *types.Header
...
// pendingEtxsVerifierFn is a callback type to verify a pendingEtxs for fast propagation.
type pendingEtxsVerifierFn func(pendingEtxs types.PendingEtxs) error

// blockBroadcasterFn is a callback type for broadcasting a block to connected peers.
type pendingEtxsBroadcasterFn func(pendingEtxs types.PendingEtxs, propagate bool)

// chainInsertFn is a callback type to insert a batch of blocks into the local chain.
type pendingEtxsInsertFn func(types.Blocks) (int, error)
...
type PendingEtxsFetcher struct {
	...
	verifyPendingEtxs    pendingEtxsVerifierFn    // Checks if a pendingEtxs have a valid ETX hash
...
func NewPendingEtxsFetcher(getPendingEtxs pendingEtxsRetrievalFn, verifyPendingEtxs pendingEtxsVerifierFn, broadcastPendingEtxs pendingEtxsBroadcasterFn, insertPendingEtxs pendingEtxsInsertFn, dropPeer peerDropFn) *PendingEtxsFetcher {
	return &PendingEtxsFetcher{
		...
		verifyPendingEtxs:    verifyPendingEtxs,
...
// importPendingEtxs spawns a new goroutine to run a block insertion into the chain. If the
