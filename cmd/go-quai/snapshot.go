...
var (
	snapshotCommand = cli.Command{
		...
		Subcommands: []cli.Command{
			{
				Name:      "prune-state",
				Usage:     "Prune stale quai state data based on the snapshot",
				ArgsUsage: "<root>",
				...
				Description: `
quai snapshot prune-state <state-root>
...
during the use of Quai, please also specify it here for correct deletion. Otherwise
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'quai dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'quai dump', but uses the snapshots
