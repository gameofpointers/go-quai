...
func (s *PublicBlockChainQuaiAPI) ReceiveWorkShare(ctx context.Context, workShare *types.WorkObjectHeader) error {
	if workShare != nil {
		...
		if workShare.NumberU64() >= params.GoldenAgeForkNumberV3 {
		...
		isWorkShare = s.b.Engine().CheckWorkThreshold(workShare, params.NewWorkSharesThresholdDiff)
...
func (s *PublicBlockChainQuaiAPI) SetWorkShareP2PThreshold(ctx context.Context, threshold hexutil.Uint64) error {
	if threshold < hexutil.Uint64(params.NewWorkSharesThresholdDiff) {
