...
func (sl *Slice) POEM(currentHeader *types.WorkObject, header *types.WorkObject) bool {
	return sl.poem(sl.engine.TotalLogS(sl.hc, header), sl.engine.TotalLogS(sl.hc, currentHeader))
}
