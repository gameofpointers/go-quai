...
type ProtoAuxPow struct {
	...
	Header    []byte  `protobuf:"bytes,2,opt,name=header,proto3,oneof" json:"header,omitempty"`       // 80B donor header
...
type ProtoAuxTemplate struct {
	...
	PayoutScript    []byte  `protobuf:"bytes,3,opt,name=payout_script,json=payoutScript,proto3,oneof" json:"payout_script,omitempty"`               // must equal coinbase.outputs[0].scriptPubKey
	ScriptSigMaxLen *uint32 `protobuf:"varint,4,opt,name=script_sig_max_len,json=scriptSigMaxLen,proto3,oneof" json:"script_sig_max_len,omitempty"` // ≤ 100
	// === Header/DAA knobs for job construction (signed) ===
	Version   *uint32 `protobuf:"varint,5,opt,name=version,proto3,oneof" json:"version,omitempty"`                      // header.nVersion to use
	Nbits     *uint32 `protobuf:"varint,6,opt,name=nbits,proto3,oneof" json:"nbits,omitempty"`                          // header.nBits
	NtimeMask *uint32 `protobuf:"varint,7,opt,name=ntime_mask,json=ntimeMask,proto3,oneof" json:"ntime_mask,omitempty"` // allowed time range/step
	Height    *uint32 `protobuf:"varint,8,opt,name=height,proto3,oneof" json:"height,omitempty"`                        // BIP34 height (needed for scriptSig + KAWPOW epoch hint)
	// === Coinbase economics (signed) ===
	CoinbaseValue *uint64 `protobuf:"varint,9,opt,name=coinbase_value,json=coinbaseValue,proto3,oneof" json:"coinbase_value,omitempty"` // subsidy + fees for output[0] (in RVN sats)
	// Mode A: COINBASE-ONLY (simplest; smallest template)
	CoinbaseOnly *bool `protobuf:"varint,10,opt,name=coinbase_only,json=coinbaseOnly,proto3,oneof" json:"coinbase_only,omitempty"` // if true => MerkleBranch is empty; tx count = 1
	// Mode B: LOCKED TX SET (miners get fees; template is larger & updated more often)
	TxCount      *uint32  `protobuf:"varint,11,opt,name=tx_count,json=txCount,proto3,oneof" json:"tx_count,omitempty"`         // total txs INCLUDING coinbase (index 0)
	MerkleBranch [][]byte `protobuf:"bytes,12,rep,name=merkle_branch,json=merkleBranch,proto3" json:"merkle_branch,omitempty"` // siblings for coinbase index=0 up to root (little endian 32-byte hashes)
	// === Miner extranonce ergonomics (signed/advisory) ===
	Extranonce2Size *uint32 `protobuf:"varint,13,opt,name=extranonce2_size,json=extranonce2Size,proto3,oneof" json:"extranonce2_size,omitempty"` // typical 4..8
	// === Quorum signatures over CanonicalEncode(template WITHOUT Sigs) ===
	Sigs []*ProtoSignerEnvelope `protobuf:"bytes,14,rep,name=sigs,proto3" json:"sigs,omitempty"`
}
...
func (x *ProtoAuxTemplate) GetPayoutScript() []byte {
	if x != nil {
		return x.PayoutScript
	}
	return nil
}

func (x *ProtoAuxTemplate) GetScriptSigMaxLen() uint32 {
	if x != nil && x.ScriptSigMaxLen != nil {
		return *x.ScriptSigMaxLen
	}
	return 0
}
...
func (x *ProtoAuxTemplate) GetCoinbaseValue() uint64 {
...
func (x *ProtoAuxTemplate) GetCoinbaseOnly() bool {
	if x != nil && x.CoinbaseOnly != nil {
		return *x.CoinbaseOnly
	}
	return false
}

func (x *ProtoAuxTemplate) GetTxCount() uint32 {
...
func (x *ProtoAuxTemplate) GetExtranonce2Size() uint32 {
	if x != nil && x.Extranonce2Size != nil {
		return *x.Extranonce2Size
	}
	return 0
}

func (x *ProtoAuxTemplate) GetSigs() []*ProtoSignerEnvelope {
	if x != nil {
		return x.Sigs
	}
	return nil
...
func (x *ProtoLockedBalance) Reset() {
	*x = ProtoLockedBalance{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_block_proto_msgTypes[48]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProtoLockedBalance) Descriptor() ([]byte, []int) {
	return file_proto_block_proto_rawDescGZIP(), []int{48}
}
...
func (x *ProtoLockups) Reset() {
	*x = ProtoLockups{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_block_proto_msgTypes[49]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProtoLockups) Descriptor() ([]byte, []int) {
	return file_proto_block_proto_rawDescGZIP(), []int{49}
}
...
func (x *ProtoSupplyAnalytics) Reset() {
	*x = ProtoSupplyAnalytics{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_block_proto_msgTypes[50]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProtoSupplyAnalytics) Descriptor() ([]byte, []int) {
	return file_proto_block_proto_rawDescGZIP(), []int{50}
}
...
var file_proto_block_proto_rawDesc = []byte{
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x72, 0x48, 0x00, 0x52, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x88, 0x01, 0x01, 0x12, 0x41,
	...
	,
	...
	,
	...
	0x6f, 0x72, 0x6b, 0x5f, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x22, 0x68, 0x0a, 0x18, 0x50, 0x72,
	0x6f, 0x74, 0x6f, 0x57, 0x6f, 0x72, 0x6b, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x53, 0x68, 0x61,
	0x72, 0x65, 0x56, 0x69, 0x65, 0x77, 0x12, 0x3c, 0x0a, 0x0b, 0x77, 0x6f, 0x72, 0x6b, 0x5f, 0x6f,
	...
	0x6a, 0x65, 0x63, 0x74, 0x22, 0x60, 0x0a, 0x10, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x41, 0x63, 0x63,
	...
	,
	...
	0x65, 0x64, 0x12, 0x2e, 0x0a, 0x04, 0x6c, 0x6f, 0x67, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b,
	...
	0x67, 0x73, 0x12, 0x2a, 0x0a, 0x07, 0x74, 0x78, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x50, 0x72, 0x6f,
	0x74, 0x6f, 0x48, 0x61, 0x73, 0x68, 0x52, 0x06, 0x74, 0x78, 0x48, 0x61, 0x73, 0x68, 0x12, 0x3f,
	0x0a, 0x10, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65,
	0x73, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	0x6e, 0x2e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x52, 0x0f,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x2d, 0x71, 0x75, 0x61, 0x69, 0x2f, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73,
...
func file_proto_block_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_block_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProtoAuxPow); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_block_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProtoSignerEnvelope); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_block_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProtoAuxTemplate); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_block_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[26].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[27].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[28].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[33].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[34].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[35].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[36].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[37].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[38].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[39].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProtoKeysAndValues); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_block_proto_msgTypes[40].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_block_proto_msgTypes[41].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProtoTokenChoiceSet); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_block_proto_msgTypes[42].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProtoTokenChoiceArray); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_block_proto_msgTypes[43].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProtoTokenChoice); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_block_proto_msgTypes[44].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProtoBetas); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_block_proto_msgTypes[45].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProtoLockup); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_block_proto_msgTypes[46].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProtoUnlock); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_block_proto_msgTypes[47].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProtoUnlocks); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_block_proto_msgTypes[48].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProtoLockedBalance); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_block_proto_msgTypes[49].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProtoLockups); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_block_proto_msgTypes[50].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProtoSupplyAnalytics); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_proto_block_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_proto_block_proto_msgTypes[1].OneofWrappers = []interface{}{}
	file_proto_block_proto_msgTypes[6].OneofWrappers = []interface{}{}
	file_proto_block_proto_msgTypes[7].OneofWrappers = []interface{}{}
	file_proto_block_proto_msgTypes[8].OneofWrappers = []interface{}{}
	file_proto_block_proto_msgTypes[9].OneofWrappers = []interface{}{}
	file_proto_block_proto_msgTypes[11].OneofWrappers = []interface{}{}
	file_proto_block_proto_msgTypes[12].OneofWrappers = []interface{}{}
	file_proto_block_proto_msgTypes[14].OneofWrappers = []interface{}{}
	file_proto_block_proto_msgTypes[16].OneofWrappers = []interface{}{}
	file_proto_block_proto_msgTypes[17].OneofWrappers = []interface{}{}
	file_proto_block_proto_msgTypes[23].OneofWrappers = []interface{}{}
	file_proto_block_proto_msgTypes[25].OneofWrappers = []interface{}{}
	file_proto_block_proto_msgTypes[26].OneofWrappers = []interface{}{}
	file_proto_block_proto_msgTypes[27].OneofWrappers = []interface{}{}
	file_proto_block_proto_msgTypes[30].OneofWrappers = []interface{}{}
	file_proto_block_proto_msgTypes[31].OneofWrappers = []interface{}{}
	file_proto_block_proto_msgTypes[32].OneofWrappers = []interface{}{}
	file_proto_block_proto_msgTypes[33].OneofWrappers = []interface{}{}
	file_proto_block_proto_msgTypes[35].OneofWrappers = []interface{}{}
	file_proto_block_proto_msgTypes[42].OneofWrappers = []interface{}{}
	type x struct{}
