...
func (h Header) MarshalJSON() ([]byte, error) {
	var enc struct {
		...
		StateFee     					*hexutil.Big   		 	`json:"stateFee"      				gencodec:"required"`
	...
	enc.StateFee = (*hexutil.Big)(h.StateFee())
...
func (h *Header) UnmarshalJSON(input []byte) error {
	...
	if dec.StateFee == nil {
		return errors.New("missing required field 'stateFee' for Header")
	}
	if dec.Extra == nil {
	...
	h.SetStateFee((*big.Int)(dec.StateFee))
