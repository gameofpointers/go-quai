...
func (hc *HeaderChain) SetCurrentHeader(head *types.WorkObject) error {
	...
	// If common header is more than 30 blocks behind, dont reorg to it
	if prevHeader.NumberU64(common.ZONE_CTX) > commonHeader.NumberU64(common.ZONE_CTX)+c_zoneHorizonThreshold {
