...
func (hc *HeaderChain) ApplyCubicDiscount(valueInt, meanInt *big.Int) *big.Float {
...
func (hc *HeaderChain) ComputeConversionFlowAmount(parent *types.WorkObject, currentBlockConversionAmount *big.Int) *big.Int {
	...
	newConversionFlowAmount = new(big.Int).Div(newConversionFlowAmount, big.NewInt(100)) // TODO: Confirm that using 100 is fine here or 1000 is needed
...
func (hc *HeaderChain) ComputeConversionAmountInQuai(header *types.WorkObject, newInboundEtxs types.Transactions) *big.Int {
