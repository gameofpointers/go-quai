...
func init() {
	...
	sharedProgpow = New(sharedConfig, nil, false, log.New("nodelogs/shared-progpow.log", "info"))
}
...
func NewTester(notify []string, noverify bool) *Progpow {
	return New(Config{PowMode: ModeTest}, notify, noverify, log.New("nodelogs/test-progpow.log", "info"))
}
