...
type Engine interface {
	...
	ComputePowLight(header *types.WorkObject) (mixHash, powHash common.Hash)
	...
	Finalize(chain ChainHeaderReader, header *types.WorkObject, state *state.StateDB, txs []*types.WorkObject,
