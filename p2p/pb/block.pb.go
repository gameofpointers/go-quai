...
type Transaction struct {
	...
	MaxPriorityGasFee []byte      `protobuf:"bytes,11,opt,name=max_priority_gas_fee,json=maxPriorityGasFee,proto3" json:"max_priority_gas_fee,omitempty"`
	MaxFeePerGas      []byte      `protobuf:"bytes,12,opt,name=max_fee_per_gas,json=maxFeePerGas,proto3" json:"max_fee_per_gas,omitempty"`
	AccessList        *AccessList `protobuf:"bytes,13,opt,name=access_list,json=accessList,proto3" json:"access_list,omitempty"`
	Sender            []byte      `protobuf:"bytes,14,opt,name=sender,proto3" json:"sender,omitempty"`
	EtxGasLimit       uint64      `protobuf:"varint,15,opt,name=etx_gas_limit,json=etxGasLimit,proto3" json:"etx_gas_limit,omitempty"`
	EtxGasPrice       []byte      `protobuf:"bytes,16,opt,name=etx_gas_price,json=etxGasPrice,proto3" json:"etx_gas_price,omitempty"`
	EtxGasTip         []byte      `protobuf:"bytes,17,opt,name=etx_gas_tip,json=etxGasTip,proto3" json:"etx_gas_tip,omitempty"`
	EtxData           []byte      `protobuf:"bytes,18,opt,name=etx_data,json=etxData,proto3" json:"etx_data,omitempty"`
	EtxAccessList     *AccessList `protobuf:"bytes,19,opt,name=etx_access_list,json=etxAccessList,proto3" json:"etx_access_list,omitempty"`
	V                 []byte      `protobuf:"bytes,20,opt,name=v,proto3" json:"v,omitempty"`
...
func (x *Transaction) GetEtxAccessList() *AccessList {
	if x != nil {
...
func (x *AccessList) Reset() {
	*x = AccessList{}
	if protoimpl.UnsafeEnabled {
		mi := &file_p2p_pb_block_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AccessList) Descriptor() ([]byte, []int) {
	return file_p2p_pb_block_proto_rawDescGZIP(), []int{6}
}
...
type AccessTuple struct {
	...
	StorageKey [][]byte `protobuf:"bytes,2,rep,name=storage_key,json=storageKey,proto3" json:"storage_key,omitempty"`
}

func (x *AccessTuple) Reset() {
	*x = AccessTuple{}
	if protoimpl.UnsafeEnabled {
		mi := &file_p2p_pb_block_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AccessTuple) Descriptor() ([]byte, []int) {
	return file_p2p_pb_block_proto_rawDescGZIP(), []int{7}
}
...
func (x *AccessTuple) GetStorageKey() [][]byte {
	if x != nil {
		return x.StorageKey
	}
	return nil
...
var file_p2p_pb_block_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x18, 0x15, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x22,
	0xf1, 0x04, 0x0a, 0x0b, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	...
	0x63, 0x68, 0x61, 0x69, 0x6e, 0x49, 0x64, 0x12, 0x2f, 0x0a, 0x14, 0x6d, 0x61, 0x78, 0x5f, 0x70,
	0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x5f, 0x67, 0x61, 0x73, 0x5f, 0x66, 0x65, 0x65, 0x18,
	0x0b, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x11, 0x6d, 0x61, 0x78, 0x50, 0x72, 0x69, 0x6f, 0x72, 0x69,
	0x74, 0x79, 0x47, 0x61, 0x73, 0x46, 0x65, 0x65, 0x12, 0x25, 0x0a, 0x0f, 0x6d, 0x61, 0x78, 0x5f,
	...
	,
	...
	0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x74, 0x6f, 0x72, 0x61,
	0x67, 0x65, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0c, 0x52, 0x0a, 0x73, 0x74,
	0x6f, 0x72, 0x61, 0x67, 0x65, 0x4b, 0x65, 0x79, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68,
	...
	0x61, 0x69, 0x2f, 0x70, 0x32, 0x70, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_p2p_pb_block_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_p2p_pb_block_proto_goTypes = []interface{}{
	...
	(*AccessList)(nil),   // 6: block.AccessList
	(*AccessTuple)(nil),  // 7: block.AccessTuple
}
var file_p2p_pb_block_proto_depIdxs = []int32{
	...
	6,  // 5: block.Transaction.access_list:type_name -> block.AccessList
	6,  // 6: block.Transaction.etx_access_list:type_name -> block.AccessList
	2,  // 7: block.Transactions.transactions:type_name -> block.Transaction
	1,  // 8: block.Headers.headers:type_name -> block.Header
	7,  // 9: block.AccessList.access_tuples:type_name -> block.AccessTuple
...
func file_p2p_pb_block_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_p2p_pb_block_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_p2p_pb_block_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
