...
var (
	...
	GardenDurationLimit    = []*big.Int{big.NewInt(300), big.NewInt(30), big.NewInt(3)}             // The decision boundary on the blocktime duration used to determine whether difficulty should go up or not.
