...
var (
	...
	GardenDurationLimit    = []*big.Int{big.NewInt(75), big.NewInt(15), big.NewInt(3)}              // The decision boundary on the blocktime duration used to determine whether difficulty should go up or not.
