...
const (
	...
	MinGasLimit          uint64 = 1000000   // Minimum the gas limit may ever be.
...
var (
	...
	GardenDurationLimit    = []*big.Int{big.NewInt(150), big.NewInt(21), big.NewInt(3)}             // The decision boundary on the blocktime duration used to determine whether difficulty should go up or not.
	...
	EntropyThresholdMultiple = []*big.Int{big.NewInt(1000), big.NewInt(200)} // The entropy theshold value to be multiplied to put in the genesis Block
)
