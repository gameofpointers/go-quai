...
const (
	...
	DuplicateUtxoSetFrequency            = 100              // The frequency in blocks at which a new duplicate UTXO set is created and old one deleted
	MaxDuplicateUtxoSets                 = 10               // The maximum number of duplicate UTXO sets that can be stored
)
